  ...
  return (
    <div className="min-h-screen pb-20 lg:pb-0">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-4 md:px-8">
        <Link href="/yachts" className="inline-flex items-center gap-2 text-xs text-gray-500 hover:text-lagoon transition-colors">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="lg:hidden">
              <div className="flex items-center gap-2 mb-2">
                <span className="rounded-md bg-lagoon-50 px-2 py-0.5 text-[10px] font-bold text-amber uppercase tracking-wider">Yacht Charter</span>
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 border-t border-border-warm bg-white/95 backdrop-blur-lg p-4 lg:hidden">
        <div className="flex items-center gap-3">
          ...
          {isSelfServe ? (
            <Link href={`/checkout?product=${p.slug}&type=yacht`} className="flex h-11 items-center justify-center rounded-xl bg-lagoon px-6 text-sm font-bold text-white">Book Now</Link>
          ) : (

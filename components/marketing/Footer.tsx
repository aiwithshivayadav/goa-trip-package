  ...
  return (
    <footer className="bg-abyss">
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <Link href="/" className="inline-flex items-center gap-3">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-lagoon">
            ...
            <div className="mt-6 flex gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/8 text-gray-400 transition-colors hover:bg-lagoon hover:text-white"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-[0.15em] text-lagoon">
              Explore
            </h3>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                ...
                >
                  <Phone className="mt-0.5 h-4 w-4 shrink-0 text-lagoon" />
                  +91 98908 30249
                </a>
              </li>
              <li>
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-sm text-gray-400 transition-colors hover:text-white"
                >
                  <Mail className="mt-0.5 h-4 w-4 shrink-0 text-lagoon" />
                  info@goatrippackage.com
                </a>
              </li>
              <li className="flex items-start gap-3 text-sm text-gray-400">
                <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-lagoon" />
            ...
            <div className="mt-8">
              ...
              <div className="flex flex-wrap items-center gap-2">
                {["PayU", "UPI", "Cards", "Net Banking"].map((m) => (
                  <span key={m} className="rounded bg-white/6 px-2.5 py-1 text-[11px] text-gray-400 border border-white/10">
                    {m}
                  </span>
                ))}
              </div>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-5 py-4 text-xs text-gray-500 md:flex-row md:px-8">
          <p>
